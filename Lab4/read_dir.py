...
# Вот тут ты берешь -0.027 7
rawData_instance.plot_bin_by_lvl_frame_all_bins(-0.027, 5)
rawData_instance.plot_bin_by_lvl_frame_all_bins(-0.027, 5, False)
# rawData_instance.hist_bin_by_lvl_frame_channel(-0.471, 5, 0, False)
